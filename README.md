...
Google (ID token)            CLI / AI agents (X-Api-Key)
   ...
   │        raw / X-Api-Key → agent-key validator ─────────────│──▶ AWS Secrets Manager
   │          │ (allowed)                                      │
   │          ▼                                                │
